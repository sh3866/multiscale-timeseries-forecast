...
echo "================================"
echo "Starting weather (Multivariate) TimeMixer_MA experiments"
echo "================================"
for pred_len in "${pred_lengths[@]}"; do
    ...
    python -u run.py \
      ...
      --model_id weather_${seq_len}_${pred_len}_${variate} \
      --model $model_name \
...
echo "================================"
echo "weather (Multivariate) TimeMixer_MA experiments completed!"
echo "================================"
