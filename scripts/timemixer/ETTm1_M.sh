...
echo "================================"
echo "Starting ETTm1 (Multivariate) TimeMixer_MA experiments"
echo "================================"
for pred_len in "${pred_lengths[@]}"; do
    ...
    python -u run.py \
      ...
      --data_path ETTm1.csv \
      --model_id ETTm1_${seq_len}_${pred_len}_${variate} \
      --model $model_name \
...
echo "================================"
echo "ETTm1 (Multivariate) TimeMixer_MA experiments completed!"
echo "================================"
