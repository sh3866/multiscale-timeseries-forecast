...
echo "================================"
echo "Starting ETTh1 (Multivariate) TimeMixer_MA experiments"
echo "================================"
for pred_len in "${pred_lengths[@]}"; do
    ...
    python -u run.py \
      ...
      --data_path ETTh1.csv \
      --model_id ETTh1_${seq_len}_${pred_len}_${variate} \
      --model $model_name \
...
echo "================================"
echo "ETTh1 (Multivariate) TimeMixer_MA experiments completed!"
echo "================================"
